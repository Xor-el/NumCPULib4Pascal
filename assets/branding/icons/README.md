...
| File | Contents |
|------|-----------|
| [`NumCPULib4Pascal.ico`](NumCPULib4Pascal.ico) | Multi-size Windows icon (16, 32, 48, 256), generated from [this logo](../logo.svg). |

## Using in Delphi (`.dproj`)

1. Open the project in the IDE.
2. **Project → Options → Application** (or **Icons** depending on version).
3. Set **Application icon** to [`NumCPULib4Pascal.ico`](NumCPULib4Pascal.ico) (path relative to the `.dproj`; from the repo root that is `assets/branding/icons/NumCPULib4Pascal.ico`).
